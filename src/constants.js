...
export const BUILD_TEMPLATE_PATH = path.join(CMD_EXEC_PATH, 'docuo-template');
export const BUILD_DOCS_PATH = path.join(BUILD_TEMPLATE_PATH, 'mdxs');
export const BUILD_PACKAGE_JSON_PATH = path.join(BUILD_TEMPLATE_PATH, 'package.json');
